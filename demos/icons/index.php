...
.ui-nosvg .ui-icon-myicon {
	background-image: url("iconimg.png");
		...
		<a href="index.php" class="ui-button ui-button-inline ui-shadow ui-corner-all ui-button-b">Link<span class="ui-button-icon-space"> </span><span class="ui-button-icon ui-icon ui-icon-delete"></span></a>
		<button data-role="none" class="ui-button ui-button-inline ui-shadow ui-corner-all ui-button-b">Button<span class="ui-button-icon-space"> </span><span class="ui-button-icon ui-icon ui-icon-delete"></span></button>
		
		<h2>Enhanced buttons with icons</h2>
		
		<p>Examples of buttons with icons that do use the Button widget, but are pre-enhanced.</p>
		
		<a href="index.php" data-role="button" data-enhanced="true" class="ui-button ui-button-inline ui-shadow ui-corner-all ui-button-b ui-widget">Link<span class="ui-button-icon-space"> </span><span class="ui-button-icon ui-icon ui-icon-delete"></span></a>
		<button data-role="button" data-enhanced="true" class="ui-button ui-button-inline ui-shadow ui-corner-all ui-button-b ui-widget">Button<span class="ui-button-icon-space"> </span><span class="ui-button-icon ui-icon ui-icon-delete"></span></button>
